 ...
 * @see AudioTrack
 */
public class CustomAndroidAudioPlayer implements AudioProcessor {
    /**
     ...
     * @see AudioTrack
     */
    public CustomAndroidAudioPlayer(TarsosDSPAudioFormat audioFormat, int bufferSizeInSamples, int streamType) {
    ...
    public CustomAndroidAudioPlayer(TarsosDSPAudioFormat audioFormat) {
